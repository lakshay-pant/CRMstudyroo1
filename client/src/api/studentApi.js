...
const addStudentUrl = 'http://localhost:5000/v1/students';
	...
	return new Promise(async (resolve, reject) => {
		try {
			const result = await axios.get(
				'http://localhost:5000/v1/students/' + _id,
				{
					headers: {
						Authorization: sessionStorage.getItem('accessJWT'),
					},
	...
	return new Promise(async (resolve, reject) => {
		try {
			const result = await axios.post(
				'http://localhost:5000/v1/students/uploadCertificate',
				frmData,
				{
					headers: {
						Authorization: sessionStorage.getItem('accessJWT'),
...
export const getAllStudents = () => {
	return new Promise(async (resolve, reject) => {
		try {
			const result = await axios.get('http://localhost:5000/v1/students', {
				headers: {
					Authorization: sessionStorage.getItem('accessJWT'),
				},
			});
...
export const getAllUserStudents = () => {
	return new Promise(async (resolve, reject) => {
		try {
			const result = await axios.get(
				'http://localhost:5000/v1/students/all-students',
				{
					headers: {
						Authorization: sessionStorage.getItem('accessJWT'),
					},
...
export const DeleteAllUserStudentTask = (id1, id2) => {
	return new Promise(async (resolve, reject) => {
		try {
			const result = await axios.delete(
				'http://localhost:5000/v1/students/' + id1 + '/' + id2,
				{
					headers: {
						Authorization: sessionStorage.getItem('accessJWT'),
					},
